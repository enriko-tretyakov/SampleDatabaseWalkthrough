...
namespace SampleDatabaseWalkthrough {
    ...
    public partial class SampleDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(int Id, string CustomerID, string CompanyName, string ContactName, string Phone) {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public OrdersRow AddOrdersRow(int OrderID, CustomersRow parentCustomersRowByFK_Orders_Customers, System.DateTime OrderDate, int OrderQuantity) {
                ...
                if ((parentCustomersRowByFK_Orders_Customers != null)) {
                    columnValuesArray[1] = parentCustomersRowByFK_Orders_Customers[1];
                }
...
namespace SampleDatabaseWalkthrough.SampleDatabaseDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customers] WHERE (([Id] = @Original_Id) AND ([CustomerID] = @Original_CustomerID) AND ([CompanyName] = @Original_CompanyName) AND ((@IsNull_ContactName = 1 AND [ContactName] IS NULL) OR ([ContactName] = @Original_ContactName)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customers] ([Id], [CustomerID], [CompanyName], [ContactName], [Phone]) VALUES (@Id, @CustomerID, @CompanyName, @ContactName, @Phone);
SELECT Id, CustomerID, CompanyName, ContactName, Phone FROM Customers WHERE (CustomerID = @CustomerID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [Id] = @Id, [CustomerID] = @CustomerID, [CompanyName] = @CompanyName, [ContactName] = @ContactName, [Phone] = @Phone WHERE (([Id] = @Original_Id) AND ([CustomerID] = @Original_CustomerID) AND ([CompanyName] = @Original_CompanyName) AND ((@IsNull_ContactName = 1 AND [ContactName] IS NULL) OR ([ContactName] = @Original_ContactName)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT Id, CustomerID, CompanyName, ContactName, Phone FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, CustomerID, CompanyName, ContactName, Phone FROM dbo.Customers";
        ...
        public virtual int Delete(int Original_Id, string Original_CustomerID, string Original_CompanyName, string Original_ContactName, string Original_Phone) {
        ...
        public virtual int Insert(int Id, string CustomerID, string CompanyName, string ContactName, string Phone) {
        ...
        public virtual int Update(int Id, string CustomerID, string CompanyName, string ContactName, string Phone, int Original_Id, string Original_CustomerID, string Original_CompanyName, string Original_ContactName, string Original_Phone) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Id, string CompanyName, string ContactName, string Phone, int Original_Id, string Original_CustomerID, string Original_CompanyName, string Original_ContactName, string Original_Phone) {
            return this.Update(Id, Original_CustomerID, CompanyName, ContactName, Phone, Original_Id, Original_CustomerID, Original_CompanyName, Original_ContactName, Original_Phone);
        }
    }
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Orders] WHERE (([OrderID] = @Original_OrderID) AND ([CustomerID] = @Original_CustomerID) AND ((@IsNull_OrderDate = 1 AND [OrderDate] IS NULL) OR ([OrderDate] = @Original_OrderDate)) AND ((@IsNull_OrderQuantity = 1 AND [OrderQuantity] IS NULL) OR ([OrderQuantity] = @Original_OrderQuantity)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Orders] ([OrderID], [CustomerID], [OrderDate], [OrderQuantity]" +
                ") VALUES (@OrderID, @CustomerID, @OrderDate, @OrderQuantity);\r\nSELECT OrderID, C" +
                "ustomerID, OrderDate, OrderQuantity FROM Orders WHERE (OrderID = @OrderID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
...
SELECT OrderID, CustomerID, OrderDate, OrderQuantity FROM Orders WHERE (OrderID = @OrderID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT OrderID, CustomerID, OrderDate, OrderQuantity FROM dbo.Orders";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_OrderID, string Original_CustomerID, global::System.Nullable<global::System.DateTime> Original_OrderDate, global::System.Nullable<int> Original_OrderQuantity) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int OrderID, string CustomerID, global::System.Nullable<global::System.DateTime> OrderDate, global::System.Nullable<int> OrderQuantity) {
            ...
            if ((OrderQuantity.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((int)(OrderQuantity.Value));
            }
            else {
                this.Adapter.InsertCommand.Parameters[3].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int OrderID, string CustomerID, global::System.Nullable<global::System.DateTime> OrderDate, global::System.Nullable<int> OrderQuantity, int Original_OrderID, string Original_CustomerID, global::System.Nullable<global::System.DateTime> Original_OrderDate, global::System.Nullable<int> Original_OrderQuantity) {
            ...
            if ((OrderQuantity.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(OrderQuantity.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[3].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CustomerID, global::System.Nullable<global::System.DateTime> OrderDate, global::System.Nullable<int> OrderQuantity, int Original_OrderID, string Original_CustomerID, global::System.Nullable<global::System.DateTime> Original_OrderDate, global::System.Nullable<int> Original_OrderQuantity) {
            return this.Update(Original_OrderID, CustomerID, OrderDate, OrderQuantity, Original_OrderID, Original_CustomerID, Original_OrderDate, Original_OrderQuantity);
        }
    }
